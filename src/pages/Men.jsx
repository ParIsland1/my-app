...
const products = [
    { id: 1, name: "Shirt 1", type: "Tops", size: "XL", image: ShirtImage },
    { id: 2, name: "Shirt 2", type: "Tops", size: "Large", image: ShirtImage },
    { id: 3, name: "Shirt 2", type: "Tops", size: "Small", image: ShirtImage },
    { id: 4, name: "Pant 1", type: "Bottoms", size: "Medium", image: JoggerImage }
];
    ...
    return (
        <div style={{ minWidth: "98vw", minHeight: "100vh", padding: "20px" }}>
            ...
            <header style={{
                ...
                <h1 style={{ fontSize: "2.5rem", margin: 0 }}>Men's Collection</h1>
            </header>
